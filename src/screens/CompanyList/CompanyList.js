  ...
  const activateDeactivate = (event, id) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        axios
          .post(
            `${process.env.REACT_APP_COMPANY_SERVICE}/company-status/${id}`,
            { status }
          )
          .then((res) => {
      ...
      <div>
        <div className="container-fluid">
          <PageHeader
            ...
            Breadcrumb={[{ name: "Company List", navigate: "#" }]}
          />
                            ...
                            <td>
                              {data.logo?.contentType ? (
                                <div className="image-container">
                                  <img
                                    src={`${process.env.REACT_APP_COMPANY_SERVICE}/company-logo/${data._id}`}
                                    alt="Company Logo"
                                  />
                                </div>
                              ) : (
